if (window.location.protocol === "file:") {
  ...
  blankScreen.style.backgroundColor = "#000000";
  ...
  headerText.textContent = "Sorry, you can't run RC2 locally.";
  ...
  explanationText1.textContent =
    "RC2's scripts and elements are not compatible with local versions.";
  ...
  liveVersionLink2.href = "https://github.com/snailvinyl/RC2/issues/new";
