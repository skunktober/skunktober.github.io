    ...
    $.fn.slides = function (option) {
        ...
        return this.each(function () {
            ...
            if (option.generateNextPrev) {
                $('.' + option.container, elem).after('<a href="#" class=" title="Previous"' + option.prev + '">Prev</a>');
                $('.' + option.prev, elem).after('<a href="#" class=" title="Next"' + option.next + '">Next</a>');
            }
            ...
            if (option.generatePagination) {
                elem.append('<ul style="width: 100px;" class=' + option.paginationClass + '></ul>');
                control.children().each(function () {
                    $('.' + option.paginationClass, elem).append('<li><a href="#' + number + '" title="">' + (number + 1) + '</a></li>');
                    number++;
                });
            } else {
...
$(window).load(function () {
    ...
    $('.slides').each(function () {
        ...
        var paginationWidth = liWidth * liNum;
