            ...
            if (target.classList.contains('custom-dropdown-option')) {
                ...
                switch (selectedOption) {
                    ...
                    case "custom":
                        ...
                        break;
                    case "r2kboy_winter":
                        imgSrc = "images/profiles/boy_winter2.png";
                        break;
                    case "r2kgirl_winter":
                        imgSrc = "images/profiles/girl_winter2.png";
                        break;
                    case "plecakserce":
                        imgSrc = "images/profiles/plecakserce.png";
                        break;
                    case "kitty":
                        imgSrc = "images/profiles/cat.png";
                        break;
                    case "banana":
                        imgSrc = "images/profiles/banana.png";
                        break;
                    case "hoppo":
                        imgSrc = "images/profiles/hoppo.png";
                        break;
                    case "gerbo":
                        imgSrc = "images/profiles/gerbo.png";
                        break;
                    case "joe":
                        imgSrc = "images/profiles/joe.png";
                        break;
                    default:
                        imgSrc = "images/profiles/male.png";
                }
